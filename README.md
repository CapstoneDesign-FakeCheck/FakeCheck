...
<img height="200" src="https://github.com/CapstoneDesign-FakeCheck/FakeCheck/tree/master/pic/main_pic.jpg"/><br>
## DATA
...
|REAL|FAKE|
|---|---:|
|<img height="200" src="https://github.com/CapstoneDesign-FakeCheck/FakeCheck/tree/master/pic/real.png"/>|
|<img height="200" src="https://github.com/CapstoneDesign-FakeCheck/FakeCheck/tree/master/pic/fake.jpg"/>|

## MODEL

## APP
Camera와 Gallery를 통해 사진을 받아온 뒤 MTCNN으로 얼굴 부분만 crop한다. 그 다음 tlite 모델의 input에 맞춰 이미지를 224*224로 resize하고 RGB채널을 BGR순서로 바꿔준다.
<img height="300" src="https://github.com/CapstoneDesign-FakeCheck/FakeCheck/tree/master/pic/app_main.png"/>
<img height="300" src="https://github.com/CapstoneDesign-FakeCheck/FakeCheck/tree/master/pic/app_result.png"/>